    ...
    return (
        <nav className='navbar-fixed orange'>
            <div className='nav-wrapper'>
                ...
                <Link to='/' className='black-text waves-effect waves-light navLink'>All Harleys</Link>
                <Link to='/wishlist' className='black-text waves-effect waves-light navLink'>Your Wishlists</Link>
